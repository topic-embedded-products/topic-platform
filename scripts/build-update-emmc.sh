...
nice bitbake ${IMAGE}-swu-emmc
echo "Sending ${IMAGE}-swu-emmc-${MACHINE}.swu to ${HOST}"
curl -F "file=@tmp-glibc/deploy/images/${MACHINE}/${IMAGE}-swu-emmc-${MACHINE}.swu" "http://${HOST}:8080/upload"
